...
При этом для test_skip используются все разрешения заданные именно в фикстуре, но в зависимости от ширины разрешения
возвращается в тест значение, позволяющее пропустить несоответствующее разрешение в нем
'''
